...
#./setup.sh
###################################################################################
ln -s synth-shell/synth-shell-prompt.config ~/.config/synth-shell/synth-shell-prompt.config
...
ln -s colorls/dark_colors.yaml ~/.config/colorls/dark_colors.yaml 
ln -s colorls/files.yaml ~/.config/colorls/files.yaml 
